...
import { Plus, Search, MoreHorizontal, CreditCard, Check, X, Eye, ChevronDown, ChevronRight, Building2, Globe, Mail, FileText } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
function AdvertiserForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <ScrollArea className="max-h-[70vh]">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-4 pr-4">
